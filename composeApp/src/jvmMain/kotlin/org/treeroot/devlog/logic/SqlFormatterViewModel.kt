...
import org.treeroot.devlog.data.SqlFormatResult
...
class SqlFormatterViewModel {
    ...
    private val formatterService = AdvancedSqlFormatterService()
     ...
     * 更新原始SQL
     */
    fun updateOriginalSql(sql: String) {
        _originalSql.value = sql
    }
